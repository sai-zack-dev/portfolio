  ...
  return (
    <>
      <Lens>
        ...
        <div className="w-full relative rounded-3xl overflow-hidden max-w-md mx-auto bg-gradient-to-r  from-gray-100 to-white dark:from-zinc-800 dark:to-black">
          {/* <Rays /> */}
          {/* <Beams /> */}
          <a
            href={link}
          ...
          >
            <img src={thumbnail} alt="image" className="rounded-2xl" />
